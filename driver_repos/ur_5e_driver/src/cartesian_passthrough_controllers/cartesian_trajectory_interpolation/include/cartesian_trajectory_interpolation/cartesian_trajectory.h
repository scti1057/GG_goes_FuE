...
public:
   ...
   */
  CartesianTrajectory(const cartesian_passthrough_msgs::msg::CartesianTrajectory& ros_trajectory);
   ...
   */
  bool init(const cartesian_passthrough_msgs::msg::CartesianTrajectory& ros_trajectory);
