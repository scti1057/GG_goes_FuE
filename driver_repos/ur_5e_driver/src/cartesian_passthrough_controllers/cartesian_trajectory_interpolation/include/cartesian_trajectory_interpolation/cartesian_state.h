...
#include <cartesian_passthrough_msgs/msg/cartesian_trajectory_point.hpp>
...
struct CartesianState
{
   ...
   */
  CartesianState(const cartesian_passthrough_msgs::msg::CartesianTrajectoryPoint& point);
   ...
   */
  cartesian_passthrough_msgs::msg::CartesianTrajectoryPoint toMsg(int time_from_start = 0) const;
