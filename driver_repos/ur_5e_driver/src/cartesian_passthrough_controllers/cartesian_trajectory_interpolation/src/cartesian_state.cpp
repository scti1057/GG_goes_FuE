...
namespace my_tf2
{
geometry_msgs::msg::Vector3 toMsg(const Eigen::Vector3d& in)
{
...
CartesianState::CartesianState(const cartesian_passthrough_msgs::msg::CartesianTrajectoryPoint& point)
{
  // Pose
...
cartesian_passthrough_msgs::msg::CartesianTrajectoryPoint CartesianState::toMsg(int time_from_start) const
{
  cartesian_passthrough_msgs::msg::CartesianTrajectoryPoint point;
